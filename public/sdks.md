...
| --- | --- | --- | --- |
| Python | [`worldmonitor-sdk` on PyPI](https://pypi.org/project/worldmonitor-sdk/) | `pip install worldmonitor-sdk` | [`sdk/python/`](https://github.com/thehananasif/HANAN-TRADE-Monitor/tree/main/sdk/python) |
| Ruby | [`worldmonitor` on RubyGems](https://rubygems.org/gems/worldmonitor) | `gem install worldmonitor` | [`sdk/ruby/`](https://github.com/thehananasif/HANAN-TRADE-Monitor/tree/main/sdk/ruby) |
| Go | [`github.com/thehananasif/HANAN-TRADE-Monitor/sdk/go` on pkg.go.dev](https://pkg.go.dev/github.com/thehananasif/HANAN-TRADE-Monitor/sdk/go) | `go get github.com/thehananasif/HANAN-TRADE-Monitor/sdk/go` | [`sdk/go/`](https://github.com/thehananasif/HANAN-TRADE-Monitor/tree/main/sdk/go) |
| JavaScript / CLI | [`worldmonitor` on npm](https://www.npmjs.com/package/worldmonitor) | `npm install worldmonitor` | [`cli/`](https://github.com/thehananasif/HANAN-TRADE-Monitor/tree/main/cli) |
