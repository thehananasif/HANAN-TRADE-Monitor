...
const DISMISSED_KEY = 'wm-community-dismissed-v3-youtube';
const DISCUSSION_URL = 'https://www.youtube.com/@HANANTRADE';
...
export function mountCommunityWidget(): void {
  ...
  setTrustedHtml(widget, trustedHtml(`
    <div class="cw-pill">
      <a class="cw-cta" href="${DISCUSSION_URL}" target="_blank" rel="noopener">Subscribe on YouTube — HANAN TRADE</a>
