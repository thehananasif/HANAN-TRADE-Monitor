...
export class ResilienceWidget {
  ...
  private render(): void {
    ...
    // HANAN TRADE Monitor: hide the whole premium widget when gated instead
    // of rendering a sign-in / upgrade pitch.
    this.element.style.display = gateReason === PanelGateReason.NONE ? '' : 'none';
