...
const DESKTOP_RELEASES_URL = 'https://github.com/thehananasif/HANAN-TRADE-Monitor/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="https://www.youtube.com/@HANANTRADE" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
    <span class="us-discussion-dot"></span>
    <span>HANAN TRADE on YouTube</span>
  </a>`;
  html += `</div></details>`;
