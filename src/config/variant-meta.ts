...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'HANAN TRADE Monitor - Real-Time Global Intelligence Dashboard',
    description: 'Real-time global intelligence platform. Conflicts, markets, military, OSINT in one view.',
    ...
    siteName: 'HANAN TRADE Monitor',
    shortName: 'HANAN TRADE Monitor',
