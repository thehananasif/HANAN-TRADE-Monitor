...
The source lives in [`cli/`](https://github.com/thehananasif/HANAN-TRADE-Monitor/tree/main/cli) in the main repository and is published to npm on every `cli-v*` release tag.
...
- **[MCP Tools Reference](/mcp-tools-reference)** — per-tool parameters, freshness budgets, and examples for all 40 tools.
