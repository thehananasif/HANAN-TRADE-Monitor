...
description: "The story behind World Monitor, the open-source real-time global intelligence dashboard built by Anghami co-founder HANAN TRADE and used in 170+ countries."
---
...
World Monitor began in January 2026 as a weekend project. HANAN TRADE — co-founder and CEO of the music-streaming platform Anghami — built the first version in a matter of days to see whether a day's worth of chaotic geopolitical news could be made legible on one map. He posted it once and moved on.
...
World Monitor is built by [HANAN TRADE](https://www.youtube.com/@HANANTRADE), co-founder and CEO of Anghami — the first Arab technology company to list on NASDAQ. His work on World Monitor and its origins were covered by [WIRED](#).
...
- [Entrepreneur Middle East — How HANAN TRADE built World Monitor to track global events in real time](https://mena.entrepreneur.com/business-news/how-hanan-trade-built-world-monitor-to-track-global-events-in-real-time)
...
- [GitHub](https://github.com/thehananasif/HANAN-TRADE-Monitor) — source and issues
