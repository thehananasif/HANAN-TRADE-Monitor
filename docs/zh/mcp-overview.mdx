...
- [#4525](https://github.com/thehananasif/HANAN-TRADE-Monitor/issues/4525) —— 延后的纯读取 MCP 覆盖候选项。
- [#4526](https://github.com/thehananasif/HANAN-TRADE-Monitor/issues/4526) —— 手动映射和 fetch-on-miss 分诊。
