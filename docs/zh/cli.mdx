---
title: "命令行客户端"
description: "使用官方 worldmonitor npm CLI 直接从 shell 脚本化调用国家简报、风险评分、监视列表与全部 39 个 MCP 工具，无需编写任何自定义 API 集成代码即可完成自动化，非常适合运维脚本、CI/CD 流水线、本地情报工作流与临时数据分析。"
---
...
源码位于主仓库的 [`cli/`](https://github.com/thehananasif/HANAN-TRADE-Monitor/tree/main/cli)，并在每个 `cli-v*` 发布标签上发布到 npm。
