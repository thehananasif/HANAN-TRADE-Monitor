...
> version ([#4200](https://github.com/thehananasif/HANAN-TRADE-Monitor/issues/4200)), and
...
> [#3789](https://github.com/thehananasif/HANAN-TRADE-Monitor/issues/3789) by keeping the
...
[`shared/cii-weights.ts`](https://github.com/thehananasif/HANAN-TRADE-Monitor/blob/main/shared/cii-weights.ts); server and frontend
