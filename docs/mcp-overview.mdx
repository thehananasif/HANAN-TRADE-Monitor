...
- [#4525](https://github.com/thehananasif/HANAN-TRADE-Monitor/issues/4525) — pure-read deferred MCP coverage candidates.
- [#4526](https://github.com/thehananasif/HANAN-TRADE-Monitor/issues/4526) — manual mapping and fetch-on-miss triage.
